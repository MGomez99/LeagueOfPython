...
def main():
    ...
    if spec_choice_1 == "name of spec 1"
        ...
        player1_spec = player1_spec.Player1(spec_choice_1, spawn,
                                            name1)  # dictionary of spec to tuple of choice,spawn,name instead? Depends on # of specs.
    ...
    '''
    spec_choice_2 = input(
        "Choose a spec for player 2 (name of specs here): ")  # prob sohuldn't be input. Rather, a selection you click maybe?
